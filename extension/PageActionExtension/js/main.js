(function() {
	...
	if (dev) {
		injectedExtScript = function() {
			...
			demoboBody.extScriptUrl = 'http://localhost:'+window.demoboRcPort+'/dev/demobo-pageaction-ext.js';
		};
	} else {
		injectedExtScript = function() {
			demoboBody.extScriptUrl = 'http://rc1.demobo.com/core/demobo-pageaction-ext-3.1.0.js?1024';
		}
	}
