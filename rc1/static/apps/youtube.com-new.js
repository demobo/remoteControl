(function() {
  var main = function(){
    ...
    Youtube.prototype.initialize = function(){
      ...
      this.setController({
        url: 'http://rc1.demobo.com/rc/youtube?0130',
      ...
      var y = this;
    	...
    	ui.fullScreen = function(){y.fullScreen.apply(y, arguments)};
    	ui.regularScreen = function(){y.regularScreen.apply(y, arguments)};
    	ui.sendStationList = function(){y.sendStationList.apply(y, arguments)};
  	...
  	Youtube.prototype.onVolume = function (value) {
  		if (value=='up') this.setVolume(parseInt(localStorage.getItem('demoboVolume'))+5);
  		else if (value=='down') this.setVolume(parseInt(localStorage.getItem('demoboVolume'))-5);
  	...
  	Youtube.prototype.syncState = function () {
  		...
  		var state = {isPlaying: isPlaying, volume: this.getVolume()};
  		this.callFunction('syncState', state);
  	};
  	
  	Youtube.prototype.toggleScreen = function () {
      var ui = this.getInfo('ui');
  		if (!ui.isFullScreen) this.fullScreen();
  		else this.regularScreen();
  	};
