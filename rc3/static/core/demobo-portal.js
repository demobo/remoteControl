...
var DEMOBO = {};
var _extensionBody = document.getElementById('extensionBody');
if (!_extensionBody) {
	_extensionBody = document.createElement('div');
	_extensionBody.setAttribute('id', 'extensionBody');
	document.body.appendChild(_extensionBody);
}
...
demobo._sendToSimulator = function(type, data) {
	...
	_extensionBody.dispatchEvent(evt);
};
