...
define(function(require, exports, module) {
    ...
    var Scroller = require('widgets/Scroller');
     ...
     */
    Scrollview.prototype.goToPreviousPage = function goToPreviousPage(skipAnimate) {
     ...
     */
    Scrollview.prototype.goToNextPage = function goToNextPage(skipAnimate) {
        if (!this._node) return null;
        var nextNode = this._node.getNext();
        if (nextNode) {
