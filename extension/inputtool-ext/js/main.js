(function() {
	...
	if (dev) {
		injectedExtScript = function() {
			...
			demoboBody.extScriptUrl = 'http://localhost:'+window.demoboRcPort+'/dev/demobo-ext-inputtool-3.1.2.js';
		};
	} else {
		injectedExtScript = function() {
			demoboBody.extScriptUrl = '//rc1-dot-de-mobo.appspot.com/core/demobo-ext-inputtool-3.1.2.js?1024';
		}
	}
