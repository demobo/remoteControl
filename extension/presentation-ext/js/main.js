(function() {
	...
	if (dev) {
		injectedExtScript = function() {
			...
			demoboBody.extScriptUrl = '//localhost:'+window.demoboRcPort+'/dev/demobo-ext-secure-3.1.1.js';
		};
	} else {
		injectedExtScript = function() {
			demoboBody.extScriptUrl = '//rc1-dot-de-mobo.appspot.com/core/demobo-ext-secure-3.1.2.js?1027';
		}
	}
